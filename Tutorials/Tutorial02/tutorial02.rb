...
if birth_date <= -1 && date < 31

  birthday_date = birth_date + 31
  user_month = birthday_month - 1

else

  birthday_date = birth_date
  user_month = birthday_month

end

age = "#{birthday_year} years , #{user_month} months , #{birthday_date} days"
